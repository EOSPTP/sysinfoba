				  ...
				  <div class="form-group">
							 ...
							 <input type="submit" class="btn btn-theme" name="submit" value="Cari">
										...
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											...
											$search = $_POST['nama'];
											$sql=mysql_query("select * from mst_customer where NAMA_CUSTOMER LIKE '%$search%' and STATUS='Y'");
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="green" href="media.php?hal=editcustomer&id=<?php echo $id;?>">
								...
								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
								<?php
											$sql=mysql_query("select * from mst_customer ORDER BY NAMA_CUSTOMER ASC");
											  //pagination config start
											$rpp = 20; // jumlah record per halaman
											$reload = "media.php?hal=cari_customer&pagination=true";
											$page = intval($_GET["page"]);
											if($page<=0) $page = 1;  
											$tcount = mysql_num_rows($sql);
											$tpages = ($tcount) ? ceil($tcount/$rpp) : 1; // total pages, last page number
