...
<html lang="en">
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
		      <form class="form-login" action="proses_login.php?op=in" method="post">
		        <h2 class="form-login-heading"><center><img src="images/logo_ptp.png" height="100"></center></h2>
    ...
    <script>
        $.backstretch("login/img/login-bg.jpg", {speed: 500});
    </script>
