...
if(isset($_POST['proses']))
{
	...
	$jam=date("H:i:s");	
	$ss=mysql_query("select * from detail_ba where KODE_BA='$kode_ba' and PRIORITAS='1'");
	$dd=mysql_fetch_array($ss);
	$pri=$dd['ID_DIVISI'];
		
	mysql_query("update stopper set TGL_KELUAR='$tgl_keluar|$jam', PENERIMA='$pri', STATUS_STOPPER='SEND' where KODE_BA='$kode_ba'");
