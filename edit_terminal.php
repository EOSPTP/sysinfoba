<section class="wrapper site-min-height">
          	...
          	<div class="row mt">
				 ...
				 <?php
				 $id=$_GET['id'];
				 $ss=mysql_query("select * from mst_terminal where ID_TERMINAL='$id'");
				 while($dd=mysql_fetch_array($ss)){
				 ?>
				  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama Terminal</label>
                              <div class="col-sm-4">
                                  <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $dd['NAMA_TERMINAL'];?>"/>
                              </div>
                          </div>
						   <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Deskripsi</label>
                              <div class="col-sm-4">
                                  <input type="text" class="form-control" id="des" name="deskripsi" value="<?php echo $dd['DESCRIPTION'];?>"/>
                              </div>
                          </div>
						  <?php
							}
...
if(isset($_POST['proses']))
{
	...
	mysql_query("update mst_terminal set NAMA_TERMINAL='$nama', DESCRIPTION='$deskripsi' where ID_TERMINAL='$id'");
